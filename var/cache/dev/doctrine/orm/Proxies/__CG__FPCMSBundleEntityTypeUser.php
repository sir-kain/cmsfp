 ...
 */
class TypeUser extends \FP\CMSBundle\Entity\TypeUser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'FP\\CMSBundle\\Entity\\TypeUser' . "\0" . 'id', '' . "\0" . 'FP\\CMSBundle\\Entity\\TypeUser' . "\0" . 'profil'];
        }
