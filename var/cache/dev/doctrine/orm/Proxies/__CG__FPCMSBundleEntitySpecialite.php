 ...
 */
class Specialite extends \FP\CMSBundle\Entity\Specialite implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'FP\\CMSBundle\\Entity\\Specialite' . "\0" . 'id', '' . "\0" . 'FP\\CMSBundle\\Entity\\Specialite' . "\0" . 'nomSpecialite'];
        }
