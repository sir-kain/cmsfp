...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('CMSFP\\TagBundle\\Form\\Type\\MedicamentsType' => function () {
    return ${($_ = isset($this->services['tag.form.type.medic']) ? $this->services['tag.form.type.medic'] : $this->load(__DIR__.'/getTag_Form_Type_MedicService.php')) && false ?: '_'};
}, 'CMSFP\\TagBundle\\Form\\Type\\PathologiesType' => function () {
    return ${($_ = isset($this->services['tag.form.type.tags']) ? $this->services['tag.form.type.tags'] : $this->load(__DIR__.'/getTag_Form_Type_TagsService.php')) && false ?: '_'};
}, 'CMSFP\\TagBundle\\Form\\Type\\PathologieshType' => function () {
    return ${($_ = isset($this->services['tag.form.type.hypothese']) ? $this->services['tag.form.type.hypothese'] : $this->load(__DIR__.'/getTag_Form_Type_HypotheseService.php')) && false ?: '_'};
}, 'CMSFP\\TagBundle\\Form\\Type\\TypeExamenType' => function () {
    return ${($_ = isset($this->services['tag.form.type.typeexam']) ? $this->services['tag.form.type.typeexam'] : $this->load(__DIR__.'/getTag_Form_Type_TypeexamService.php')) && false ?: '_'};
}, 'FOS\\UserBundle\\Form\\Type\\ChangePasswordFormType' => function () {
    return ${($_ = isset($this->services['fos_user.change_password.form.type']) ? $this->services['fos_user.change_password.form.type'] : $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('FP\\CMSBundle\\Entity\\Utilisateur')) && false ?: '_'};
}, 'FOS\\UserBundle\\Form\\Type\\ProfileFormType' => function () {
    return ${($_ = isset($this->services['fos_user.profile.form.type']) ? $this->services['fos_user.profile.form.type'] : $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('FP\\CMSBundle\\Entity\\Utilisateur')) && false ?: '_'};
}, 'FOS\\UserBundle\\Form\\Type\\RegistrationFormType' => function () {
    return ${($_ = isset($this->services['fos_user.registration.form.type']) ? $this->services['fos_user.registration.form.type'] : $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('FP\\CMSBundle\\Entity\\Utilisateur')) && false ?: '_'};
}, 'FOS\\UserBundle\\Form\\Type\\ResettingFormType' => function () {
    return ${($_ = isset($this->services['fos_user.resetting.form.type']) ? $this->services['fos_user.resetting.form.type'] : $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('FP\\CMSBundle\\Entity\\Utilisateur')) && false ?: '_'};
