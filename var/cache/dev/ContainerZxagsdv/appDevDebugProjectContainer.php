...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array())
    {
        ...
        $this->fileMap = array(
            ...
            'fpcms.roleuser' => __DIR__.'/getFpcms_RoleuserService.php',
            ...
            'tag.form.type.hypothese' => __DIR__.'/getTag_Form_Type_HypotheseService.php',
            'tag.form.type.medic' => __DIR__.'/getTag_Form_Type_MedicService.php',
            'tag.form.type.tags' => __DIR__.'/getTag_Form_Type_TagsService.php',
            'tag.form.type.typeexam' => __DIR__.'/getTag_Form_Type_TypeexamService.php',
            ...
            'upload.annotation_reader' => __DIR__.'/getUpload_AnnotationReaderService.php',
            'upload.handler' => __DIR__.'/getUpload_HandlerService.php',
            'upload.subscriber' => __DIR__.'/getUpload_SubscriberService.php',
        ...
        $this->privates = array(
            ...
            'tag.form.type.hypothese' => true,
            'tag.form.type.medic' => true,
            'tag.form.type.tags' => true,
            'tag.form.type.typeexam' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('D9YN43gTh-', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oC-RO7m6lb', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('t5WO6VvtAW', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jX28CFT-Nk', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('07c12f5ae5dd188d82e67d6d84a642377e844461')) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('07c12f5ae5dd188d82e67d6d84a642377e844461');
    }
        ...
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'FPCMSBundle' => array(
                    ...
                    'path' => ($this->targetDirs[3].'/src/FP/CMSBundle'),
                ...
                'TagBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/CMSFP/TagBundle'),
                    'namespace' => 'CMSFP\\TagBundle',
                ),
                'UploadUploadBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Upload/UploadBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FPCMSBundle' => 'FP\\CMSBundle\\FPCMSBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'TagBundle' => 'CMSFP\\TagBundle\\TagBundle',
                'UploadUploadBundle' => 'Upload\\UploadBundle\\UploadUploadBundle',
            ...
            'secret' => '07c12f5ae5dd188d82e67d6d84a642377e844461',
            'locale' => 'fr',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '07c12f5ae5dd188d82e67d6d84a642377e844461',
            ...
            'twig.form.resources' => array(
                ...
                1 => 'FPCMSBundle::form_utils/bootstrap_4_layout.html.twig',
            ),
            ...
            'fos_user.model.user.class' => 'FP\\CMSBundle\\Entity\\Utilisateur',
